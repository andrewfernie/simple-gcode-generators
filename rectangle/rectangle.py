...
class Application(Frame):
	...
	def createWidgets(self):
		...
		self.TotalDepth = Entry(self, width=10, textvariable=self.TotalDepthVar)
	...
	def GenCode(self):
		...
		if len(self.DepthOfCutVar.get())>0:
			...
			self.NumOfZSteps = int(self.FToD(self.TotalDepthVar.get()) / self.Z_Step)
	...
	def LoadPrefs(self):
		self.NcDir=self.GetIniData('rectangle.ini','Directories','NcFiles',os.path.expanduser("~"))
		self.FeedrateVar.set(self.GetIniData('rectangle.ini','MillingPara','Feedrate','1000'))
		self.DepthOfCutVar.set(self.GetIniData('rectangle.ini','MillingPara','DepthOfCut','3'))
		self.ToolDiameterVar.set(self.GetIniData('rectangle.ini','MillingPara','ToolDiameter','10'))
		self.SpindleRPMVar.set(self.GetIniData('rectangle.ini','MillingPara','SpindleRPM','9000'))
		self.LeadinVar.set(self.GetIniData('rectangle.ini','MillingPara','Leadin'))
		self.UnitVar.set(int(self.GetIniData('rectangle.ini','MillingPara','UnitVar','2')))
		self.HomeVar.set(int(self.GetIniData('rectangle.ini','MillingPara','HomeVar','4')))
		self.InOutVar.set(int(self.GetIniData('rectangle.ini','MillingPara','InOutVar','1')))
		self.SafeZVar.set(self.GetIniData('rectangle.ini','MillingPara','SafeZ','10.0'))
		self.SizeXVar.set(self.GetIniData('rectangle.ini','Part', 'Size X', '10'))
		self.SizeYVar.set(self.GetIniData('rectangle.ini','Part', 'Size Y', '10'))
		self.TotalDepthVar.set(self.GetIniData('rectangle.ini','Part','TotalDepth'))
...
app = Application()
app.master.title('Rectangle Cutting G-Code Generator Version ' + version)
app.mainloop()
